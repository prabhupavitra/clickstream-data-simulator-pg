...
if __name__ == '__main__':
    ...
    for day in days:
        ...
        print(f"send {day_events_count} events for {day_str} cost: {utils.current_timestamp() - start_gen_day_user_event_time}ms\n")

    print(f"job finished, uploaded {total_events_count} events, cost: {utils.current_timestamp() - start_time}ms\n")
